...
LiveVisitData liveVisitDataFromJson(String str) => LiveVisitData.fromJson(json.decode(str));
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        imagesmap: List<Imagesmap>.from(json["Imagesmap"].map((x) => Imagesmap.fromJson(x))),
        ...
        finalizationlist: List<dynamic>.from(json["Finalizationlist"].map((x) => x)),
...
class Imagesmap {
    ...
    factory Imagesmap.fromJson(Map<String, dynamic> json) => Imagesmap(
        ...
        uploadimage: List<Uploadimage>.from(json["uploadimage"].map((x) => Uploadimage.fromJson(x))),
        drawimage: json["drawimage"],
        imagesmaplist: List<Imagesmaplist>.from(json["Imagesmaplist"].map((x) => Imagesmaplist.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "drawimage": drawimage,
        "Imagesmaplist": List<dynamic>.from(imagesmaplist.map((x) => x.toJson())),
    };
}
